...
public class PlanCompareNewAdapter extends RecyclerView.Adapter<PlanCompareNewAdapter.ViewHolder>{
    private List<PlanNewDTO> list;
    private Context context;
    private OnItemClickListner.OnClickCallback onClickCallback;


    public PlanCompareNewAdapter(Context context, List<PlanNewDTO> list,
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        PlanNewDTO dto = list.get(position);
        if (dto != null) {
           //  holder.tvName.setText(dto.getHDAvailable());
             holder.tvName.setText("Rajendra");
