...
public class ReviewsList_Adapter extends BaseAdapter {
    ...
    String name = "";
    private ArrayList<GetReviewResp> country_lists;

    public ReviewsList_Adapter(Context context, ArrayList<GetReviewResp> country_lists,OnItemClickListner.OnClickCallback onClickCallback, String name) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.llReview = (LinearLayout) rowView.findViewById(R.id.ll_select);

        holder.tv_genreName.setText(String.valueOf(country_lists.get(position).getDescription()));
        holder.llReview.setOnClickListener(new OnItemClickListner(position, onClickCallback, ""));
...
//        });
    ...
    public void clickreviewposition(int clickPosition)
    {
