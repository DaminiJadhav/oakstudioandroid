...
public class PaypalActivityOld extends AppCompatActivity implements View.OnClickListener {
  ...
  Intent intent=getIntent();
    ...
    private void getPayment() {
        ...
        if(editTextAmount.getText().toString()==null || editTextAmount.getText().toString().equals("")){
            Toast.makeText(PaypalActivityOld.this,"Enter amount",Toast.LENGTH_LONG).show();
}       else
