package com.sdaemon.oakstudiotv.audioorsubtitletrack;
...
public class TrackS extends LinearLayout {
    private final int selectableItemBackgroundResourceId;
    private final LayoutInflater inflater;
    private final CheckedTextView disableView;
    private final CheckedTextView defaultView;
    private final TrackS.ComponentListener componentListener;
    ...
    /**
     * Gets a pair consisting of a dialog and the {@link TrackS} that will be shown by it.
     *
     * @param activity The parent activity.
     * @param title The dialog's title.
     * @param trackSelector The track selector.
     * @param rendererIndex The index of the renderer.
     * @return The dialog and the {@link TrackS} that will be shown by it.
     */
    public static Pair<AlertDialog, TrackS> getDialog(
            Activity activity,
            CharSequence title,
        ...
        View dialogView = dialogInflater.inflate(R.layout.exoplayer_track, null);

        TrackS selectionView = dialogView.findViewById(R.id.exo_track_selection_view);
    ...
    public TrackS(Context context, @Nullable AttributeSet attrs) {
    ...
    public TrackS(
        ...
        componentListener = new TrackS.ComponentListener();
