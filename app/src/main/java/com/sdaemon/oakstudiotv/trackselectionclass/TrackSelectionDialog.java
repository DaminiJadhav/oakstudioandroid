...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  public static final class TrackSelectionViewFragment extends Fragment
     implements com.sdaemon.oakstudiotv.trackselectionclass.TrackSelectionView.TrackSelectionListener {
    ...
    public View onCreateView(
      ...
      View rootView =
          inflater.inflate(
              R.layout.exo_track_selection_dialog3, container, /* attachToRoot= */ false);
      TrackSelectionView trackSelectionView = rootView.findViewById(R.id.trackselection_view);
...
//  Drawable dr = this.getResources().getDrawable(R.drawable.logo);
//                        Bitmap bitmap = ((BitmapDrawable) dr).getBitmap();
//                        Drawable d = new BitmapDrawable(this.getResources(), Bitmap.createScaledBitmap(bitmap, 75, 75, true));
//                        trackView.setCompoundDrawablesWithIntrinsicBounds(d, null, null, null);
//   trackView.setCompoundDrawablesWithIntrinsicBounds(
//  d, 0, 0, 0);
}
