...
public class NewTrackSelection extends LinearLayout {
    private int selectableItemBackgroundResourceId;
    private  LayoutInflater inflater;
    private  CheckedTextView disableView;
    private CheckedTextView defaultView;
    private  NewTrackSelection.ComponentListener componentListener;
     ...
     */
    public static Pair<AlertDialog, NewTrackSelection> getDialog(
            Activity activity,
            CharSequence title,
        ...
        View dialogView = dialogInflater.inflate(R.layout.exo_track_selection_dialogbox1, null);

        final NewTrackSelection selectionView = dialogView.findViewById(R.id.exo_track_Selection_view1);
    ...
    public NewTrackSelection(Context context) {
        this(context, null);
    }

    public NewTrackSelection(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressWarnings("nullness")
    public NewTrackSelection(
        ...
        componentListener = new NewTrackSelection.ComponentListener();
    ...
    private class ComponentListener implements OnClickListener {
        ...
        public void onClick(View view) {
            NewTrackSelection.this.onClick(view);
        }
    }
